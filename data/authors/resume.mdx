...
<div className="!mt-0 text-sm italic text-white">Ho Chi Minh City, March 2023 - Now</div>
...
<div className="!mt-0 text-sm italic text-white">Ho Chi Minh City, March 2022 - October 2022 (8 Months)</div>
...
- React - The Complete Guide (incl Hooks, React Router, Redux). <br />
  <div className="!m-0 text-sm italic text-white">From Udemy at February 7, 2023.</div>
- Node.js, Express, MongoDB & More: The Complete Bootcamp 2022. <br />
  <div className="!m-0 text-sm italic text-white">From Udemy at February 20, 2022.</div>
- Language : TOEIC <br />
  <div className="!m-0 text-sm italic text-white">Score: 660/990 at IIG Viet Nam</div>
