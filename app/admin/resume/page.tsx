  ...
  return (
    <div className="container mx-auto py-10">
      ...
      <Card className="mx-auto mt-2 max-w-5xl">
        <CardHeader>
          <CardTitle className="text-3xl">Admin Resume</CardTitle>
          <CardDescription>Manage the admin resume</CardDescription>
        </CardHeader>
        <CardContent>
          {author ? (
            <div className="space-y-8">
              ...
              <Alert>
                ...
                <AlertDescription>
                  An author Resume for {author.name} has been found. File path:
                  {author.filePath}
                </AlertDescription>
              </Alert>
            </div>
            ...
            <Alert variant="destructive">
              ...
              <AlertDescription>
                There is no author resume created yet. Use the button below to
                create one.
              </AlertDescription>
            </Alert>
          )}
        ...
        <CardFooter className="flex justify-end space-x-4">
          {author ? (
            <Button asChild>
              <Link href="/admin/resume/edit">
                Edit Resume <ExternalLink className="ml-2 h-4 w-4" />
              </Link>
            </Button>
          ) : (
            <Button asChild>
              <Link href="/admin/resume/new">
                Create Resume <ExternalLink className="ml-2 h-4 w-4" />
              </Link>
            </Button>
          )}
        </CardFooter>
