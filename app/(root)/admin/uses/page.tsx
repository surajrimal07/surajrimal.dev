  ...
  return (
    <div className="container mx-auto py-10">
      ...
      <Card className="mx-auto mt-2 max-w-5xl">
        <CardHeader>
          <CardTitle className="text-3xl">Author Uses</CardTitle>
          <CardDescription>
            Manage the author uses for your site
          </CardDescription>
        </CardHeader>
        <CardContent>
          {author ? (
            <div className="space-y-8">
              ...
              <Alert>
                <AlertTitle>Author Uses Exists</AlertTitle>
                <AlertDescription>
                  An author uses for {author.name} has been found. File path:
                  {author.filePath}
                </AlertDescription>
              </Alert>
            </div>
            ...
            <Alert variant="destructive">
              <AlertTitle>No Author Uses Found</AlertTitle>
              <AlertDescription>
                There is no author uses created yet. Use the button below to
                create one.
              </AlertDescription>
            </Alert>
          )}
        ...
        <CardFooter className="flex justify-end space-x-4">
          {author ? (
            <Button asChild>
              <Link href="/admin/uses/edit">
                Edit Uses <ExternalLink className="ml-2 h-4 w-4" />
              </Link>
            </Button>
          ) : (
            <Button asChild>
              <Link href="/admin/uses/new">
                Create Uses <ExternalLink className="ml-2 h-4 w-4" />
              </Link>
            </Button>
          )}
        </CardFooter>
