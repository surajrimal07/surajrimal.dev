...
const ContentSecurityPolicy = `
  ...
  img-src 'self' data: blob: https://wakapi.dev https://twitter.github.io https://*.r2.dev https://stats.surajrimal.dev https://www.gravatar.com https://seccdn.libravatar.org;
  media-src 'self';
